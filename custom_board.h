...
// LEDs definitions for DRIMIUN_BOARD
...
#define BSP_LED_0      NRF_GPIO_PIN_MAP(1,15)
#define BSP_LED_1      NRF_GPIO_PIN_MAP(1,10)
#define BSP_LED_2      15
#define BSP_LED_3      16

#define BUTTONS_NUMBER 4

#define BUTTON_1       NRF_GPIO_PIN_MAP(1,2)    //USER BUTTON
#define BUTTON_2       NRF_GPIO_PIN_MAP(0,4)    //BATTERY CHARGING
#define BUTTON_3       NRF_GPIO_PIN_MAP(0,8)    //POWER BUTTON
#define BUTTON_4       NRF_GPIO_PIN_MAP(0,27)   //PLATFORM BUTTON
...
#define RX_PIN_NUMBER  NRF_GPIO_PIN_MAP(0,24) //CABLE_SERIAL_TXD
#define TX_PIN_NUMBER  NRF_GPIO_PIN_MAP(0,25) //CABLE_SERIAL_RXD
